...
export default function polygoin3_failed() {
  return (
          ...
          <div className='border-[2px] border-black border-b-0 border-l-0 grid grid-cols-[71vw,20.5vw]'>
            <div className='border-r-4 h-full w-full border-black grid grid-rows-[33vw,7.8vw]'>
              <div className='border-b-4 border-black grid grid-rows-2 w-full text-[2.5rem]'>
                  <div className='flex font-mplus items-center pl-20'>Sorry, You are not allowed to use this platform.</div>
                  ...
                  <div className='pr-[2vw] text-[3rem] text-[#E86C66]'>𝙓</div><div className='text-[2rem] text-[#E86C66]'>Verified Failed</div>
                    </div> 
                  </div>        
              </div>
            ...
            <div className='grid grid-rows-[26vw,7vw,7vw]'>
              ...
              <div className='flex text-center items-center justify-center border-b-4 border-black bg-[#FFE3D3] text-[2.5rem]'>GO TO HOME <span className='text-[3.5rem] pl-4'>→</span></div>
