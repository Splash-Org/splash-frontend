          ...
          <div className="grid grid-cols-[1fr,1fr,1fr] border-[2px]  ">
            <div className="relative">
              <div
                ...
                className="col-span-1 h-full  cursor-pointer bg-white text-center "
                style={{
              ...
              <div
                onClick={() => router.push("/player")}
                className=" absolute top-[30.2vw] left-[6vw] cursor-pointer bg-[#EAD762] pt-1 pb-1 pl-20 pr-20 text-[1.8rem] text-gray-800 hover:bg-[#bfea62] hover:text-white "
              >
                WATCH →
              </div>
            </div>
