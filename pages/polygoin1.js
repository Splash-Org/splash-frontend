          ...
          <div className='border-[2px] border-black border-b-0 border-l-0 grid grid-cols-[71vw,20.5vw]'>
            <div className='border-r-4 h-full w-full border-black grid grid-rows-[33vw,7.8vw]'>
              <div className='border-b-4 border-black grid grid-rows-2 w-full text-[2.5rem]'>
                  <div className='flex font-mplus items-center pl-20'>Choose your traits to verify by PolygonID.</div>
                  <div className='flex-col space-y-10'>
                    <div className='flex pl-[20vw] items-center'>
                      <input type="checkbox" class="accent-green-900 h-6 w-6 rounded-full mr-6 " /> AGE (Required Over 18 +)
                    </div>    
                    <div className='flex pl-[20vw] items-center'>
                      <input type="checkbox" class="accent-green-900 h-6 w-6 rounded-full mr-6 " /> DAO Reputation
                    </div> 
                  </div>        
              </div>
